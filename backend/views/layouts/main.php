        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <form role="search" class="navbar-form-custom" action="" onsubmit="return false;">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <span class="m-r-sm text-muted welcome-message">欢迎访问.</span>
                    </li>
                    <li class="dropdown">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        setTimeout(function () {
            ...
            toastr.success(' ', '欢迎你 <?=Yii::$app->user->identity->username;?>');
        }, 1300);
    });
